...
s.name         = "MMTapBar"                #名称
s.version      = "0.0.1"                #版本号
s.summary      = "Similar to the TabBar controls of Tencent sports"        #简短介绍
s.description  = <<-DESC
私有Pods测试
* Markdown 格式
DESC
...
s.source       = { :git => "https://github.com/YYWDark/MMTapBar.git" }
...
s.public_header_files = 'MMTapBar/**/*.h'
s.source_files  = "MMTapBar/**/*.{h,m}"    #OC可以使用类似这样"Classes/**/*.{h,m}"

s.frameworks = 'UIKit', 'QuartzCore', 'Foundation'    #所需的framework,多个用逗号隔开
s.module_name = 'MMTapBar'                #模块名称
